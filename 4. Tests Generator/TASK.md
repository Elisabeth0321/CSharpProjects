...
* [Walkthrough: Creating a Dataflow Pipeline](https://docs.microsoft.com/en-us/dotnet/standard/parallel-programming/walkthrough-creating-a-dataflow-pipeline)

**Главный метод генератора должен возвращать Task и не выполнять никаких ожиданий внутри (блокирующих вызовов `task.Wait()`, `task.Result`, etc). Для ввода-вывода также необходимо использовать асинхронный API (см.** [**Asynchronous File I/O**](https://docs.microsoft.com/en-us/dotnet/standard/io/asynchronous-file-i-o)**).**
...
* [The .NET Compiler Platform](https://github.com/dotnet/roslyn)
